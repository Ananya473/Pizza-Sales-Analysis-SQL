...
--   Question 1: retrieve total nos of orders placed. 
...
-- Question 9: Question 2: Calculate the percentage contribution of each pizza type to total revenue.
select pizza_types.category,
round(sum(order_details.quantity*pizzas.price) /(select 
round(sum(order_details.quantity*pizzas.price),2) AS total_salesn 
...
-- Question 11: Determine the top 3 most ordered pizza types based on revenue for each pizza category.
